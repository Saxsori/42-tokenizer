...
ERC-20 was chosen because it is the most widely adopted token standard on the Ethereum ecosystem. It provides a well-defined interface that ensures compatibility with wallets, decentralized applications (dApps), and blockchain explorers.

### Why OpenZeppelin?

OpenZeppelin's audited smart contract libraries are used to improve security, reduce development time, and follow established industry best practices rather than implementing the ERC-20 standard from scratch.
